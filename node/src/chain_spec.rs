  ...
  Ok(ChainSpec::from_genesis(
    ...
    move || testnet_genesis(
      ...
      vec![
        ...
        // subkey inspect "$SECRET//bittok//1//validator"
        // subkey inspect "$SECRET//bittok//1//babe"
        // subkey inspect --scheme ed25519 "$SECRET//bittok//1//grandpa"
        // subkey inspect "$SECRET//bittok//1//imonline"
        // subkey inspect "$SECRET//bittok//1//discovery"
        (
        ...
        // subkey inspect "$SECRET//bittok//2//validator"5FNQoCoibJMAyqC77og9tSbhGUtaVt51SD7GdCxmMeWxPBvX
        // subkey inspect "$SECRET//bittok//2//babe"
        // subkey inspect --scheme ed25519 "$SECRET//bittok//2//grandpa"
        // subkey inspect "$SECRET//bittok//2//imonline"
        // subkey inspect "$SECRET//bittok//2//discovery"
        (
        ...
        // subkey inspect "$SECRET//bittok//3//validator"
        // subkey inspect "$SECRET//bittok//3//babe"
        // subkey inspect --scheme ed25519 "$SECRET//bittok//3//grandpa"
        // subkey inspect "$SECRET//bittok//3//imonline"
        // subkey inspect "$SECRET//bittok//3//discovery"
        (
      ...
      // subkey inspect "$SECRET//bittok//root"
    ...
    // Bootnodes
    vec![
      "/dns/seed1.rose-cc2.bittoknode.com/tcp/30333/p2p/12D3KooWPb5VY3dzydLFVh4Bn8sk73QvicvVoYcHQawRgicuMNwJ"
        .parse()
        .unwrap(),
      "/dns/seed2.rose-cc2.bittoknode.com/tcp/30333/p2p/12D3KooWG4jPV345wrEE23tdRh69i9YH5BtSo8RhToPj4fTaJgkZ"
        .parse()
        .unwrap(),
    ],
    // Telemetry
