...
pub const VERSION: RuntimeVersion = RuntimeVersion {
  spec_name: create_runtime_str!("bittok"),
  impl_name: create_runtime_str!("bittok"),
  authoring_version: 1,
  spec_version: 16,
  impl_version: 1,
...
impl bittok_claims::Config for Runtime {
...
construct_runtime!(
    ...
    UncheckedExtrinsic = UncheckedExtrinsic
  {
    ...
    BittokClaims: bittok_claims::{Module, Call, Storage, Event<T>, ValidateUnsigned},
  }
);
