...
pub use bittok_rpc_runtime_api::CurrencyExchangeApi as CurrencyExchangeRuntimeApi;
...
pub trait CurrencyExchangeRpc<BlockHash, AccountId, CurrencyId, Balance, Rate, Share> {
  #[rpc(name = "bittok_targetAmountAvailable")]
  ...
  #[rpc(name = "bittok_supplyAmountNeeded")]
  ...
  #[rpc(name = "bittok_getExchangeRate")]
  fn get_exchange_rate(&self, at: Option<BlockHash>) -> Result<Rate>;

  #[rpc(name = "bittok_toAddLiquidity")]
  ...
  #[rpc(name="bittok_getAccountStakingInfo")]
